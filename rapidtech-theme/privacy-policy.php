...
<head>
<?php rt_head([
    'title'       => 'Privacy Policy | ' . RT::NAME,
    'description' => 'How Rapid Tech Solutions collects, uses, stores and protects your personal information, and how to request access to or deletion of your data.',
    'path'        => '/privacy-policy',
]); ?>
</head>
<body>
...
<main id="main">
    <div class="article-header">
        <div class="container">
            <?php rt_breadcrumbs(['Privacy Policy' => '/privacy-policy']); ?>
    ...
    <article class="article-content">
        ...
        <section>
            ...
            <ul>
                <li><strong>WhatsApp:</strong> Customer communication via WhatsApp (see Meta's privacy policy)</li>
        ...
        <section>
            ...
            <ul>
                ...
                <li><strong>Email:</strong> <?php echo RT::e(RT::EMAIL_PRIVACY); ?></li>
