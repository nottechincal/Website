...
<div class="stats-bar"><div class="wrap">
  ...
  <div class="stat"><div class="stat-icon">📍</div><b><?php echo rt_suburb_count(); ?>+</b><span>Suburbs, no call-out fee</span></div>
</div></div>
...
<section id="reviews" class="reviews-strip"><div class="wrap">
  ...
  <div class="reviews-scroll" id="reviewsScroll">
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Fantastic service. My laptop was running incredibly slow and they fixed it same day. Honest, reliable, explained what they were doing the whole time."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">Sarah M.</a></cite><p class="r-info">Patterson Lakes · 3 weeks ago</p><span class="r-tag fast">Same-day fix</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Saved my business. We had a ransomware attack and they had us back running within hours. Professional, knowledgeable and genuinely cared."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">David R.</a></cite><p class="r-info">Seaford · business owner · 1 month ago</p><span class="r-tag value">Saved business</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Finally someone who explains things without the jargon. Sorted our whole home network — WiFi works perfectly in every room now."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">The Thompson Family</a></cite><p class="r-info">Frankston · 2 months ago</p><span class="r-tag kind">Explained clearly</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Thought my hard drive was dead and I'd lost everything. He recovered all my photos and documents. Can't recommend enough."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">Michael T.</a></cite><p class="r-info">Berwick · 3 weeks ago</p><span class="r-tag value">Data saved</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Came out same day, had the screen replaced on my daughter's laptop within an hour. Fair price, great work, lovely bloke."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">Lisa K.</a></cite><p class="r-info">Cranbourne · 1 month ago</p><span class="r-tag fast">Same-day fix</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Fixed my gaming PC that I'd built myself and couldn't get to POST. Knew exactly what the issue was. Running better than ever."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">Jake P.</a></cite><p class="r-info">Narre Warren · 2 months ago</p><span class="r-tag kind">Gaming PC</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Called about constant WiFi dropouts. He came out, diagnosed interference from a neighbour's repeater, fixed the channel settings. No problems since."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">Amanda W.</a></cite><p class="r-info">Chelsea · 1 month ago</p><span class="r-tag fast">WiFi sorted</span></div>
    <div class="r-card"><div class="r-stars">★★★★★</div><p class="r-text">"Honest, upfront pricing. Told me my old laptop wasn't worth fixing and helped me set up the new one instead. Didn't charge for the advice."</p><cite class="r-name"><a href="<?php echo RT::GOOGLE_REVIEW_URL; ?>" rel="noopener nofollow" target="_blank" style="color:inherit;text-decoration:none;">Robert C.</a></cite><p class="r-info">Dandenong · 3 months ago</p><span class="r-tag kind">Honest advice</span></div>
  </div>
