<?php
/*
Template Name: Postcode: Rowville (3178)
*/
...
render_location_page([
    ...
    'postcode' => '3178',
    'nearby_suburbs' => ['Lysterfield', 'Ferntree Gully', 'Scoresby', 'Mulgrave', 'Wheelers Hill'],
    'distance_from_base' => '32',
    'landmarks' => ['Stud Park Shopping Centre', 'Rowville Community Centre', 'Lysterfield Lake Park', 'Wellington Village', 'Stamford Park'],
    'geo_lat' => '-37.9333',
    'geo_long' => '145.2333',
    'population' => '35,000',
    'common_issues' => ['home office optimization', 'family network security', 'smart home integration', 'NBN performance issues'],
    'suburb_description' => 'Premium IT support for Rowville\'s family-focused community. From Stud Park to Wellington Village, we provide reliable technology solutions for homes and businesses in this thriving suburb.',
    'unique_content' => '
        <h2>Family-Focused IT Solutions in Rowville</h2>
        ...
        <h3>Educational Technology Support</h3>
        <p>Rowville\'s excellent schools, including Rowville Secondary College and numerous primary schools, mean students need robust technology support. We help families configure study spaces with fast, reliable internet, set up parental controls that balance safety with privacy, and maintain laptops and tablets used for schoolwork. We understand that education technology has become essential to academic success.</p>

        <h3>Small Business Support in Stud Park Precinct</h3>
