<?php
/*
Template Name: Postcode: Mentone (3194)
*/
...
render_location_page([
    'suburb_name' => 'Mentone',
    'postcode' => '3194',
    'nearby_suburbs' => ['Parkdale', 'Mordialloc', 'Cheltenham', 'Beaumaris', 'Moorabbin'],
    'distance_from_base' => '12',
    'landmarks' => ['Mentone Beach', 'Mentone Railway Station', 'Mentone Shopping Strip', 'Como Parade', 'Thrift Park'],
    'geo_lat' => '-37.9833',
    'geo_long' => '145.0667',
    'population' => '10,500',
    'common_issues' => ['beach lifestyle connectivity', 'cafe POS systems', 'retail networks', 'residential NBN optimization'],
    'suburb_description' => 'Local IT expertise for Mentone\'s vibrant coastal community. From the famous shopping strip to the beautiful beach, we provide reliable technology support that keeps Mentone businesses and homes connected.',
    'unique_content' => '
        <h2>Community-Focused IT Services in Mentone</h2>
        <p>Mentone perfectly balances coastal lifestyle with urban convenience, featuring a thriving shopping strip, beautiful beach, and strong community spirit. The suburb attracts families and professionals who appreciate its character and accessibility. Our IT services reflect this community focus—reliable, friendly, and tailored to local needs.</p>

        <h3>Retail IT for Mentone\'s Famous Shopping Strip</h3>
